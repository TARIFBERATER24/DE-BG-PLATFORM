...
const steps = [
  ...
  },
  {
    title: "IBAN и SEPA",
    description:
      "Как работи немският IBAN и защо повечето договори се плащат чрез директен дебит, не с ръчен превод.",
  ...
  {
    title: "Kündigungsfrist — прекратяване на договор",
    description:
      "Как да прекратите договор навреме, за да не се удължи автоматично без да искате.",
